...
public sealed class References
{
    ...
    static void CheckLiveEntity(WorldReference world, EntityReference entity)
    {
    ...
    static void CheckDeadEntity(EntityReference entity)
    {
    ...
    static void CheckLiveWorld(WorldReference world, Scene scene)
    {
    ...
    static void CheckDeadWorld(WorldReference world, Scene scene)
    {
