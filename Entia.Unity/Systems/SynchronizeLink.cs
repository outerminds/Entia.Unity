...
{
    public struct SynchronizeLink : IReact<OnAdd<Components.Link>>, IReact<OnRemove<Components.Link>>
    {
        ...
        [Default]
        static SynchronizeLink Default => new SynchronizeLink
        {
        ...
        public readonly Components<Components.Link> Links;

        Lazy<Transform> _root;
        Dictionary<EntityReference, Data> _pools;
        Dictionary<GameObject, (Data data, Instance instance)> _instances;

        void IReact<OnAdd<Components.Link>>.React(in OnAdd<Components.Link> message)
        {
        ...
        void IReact<OnRemove<Components.Link>>.React(in OnRemove<Components.Link> message)
        {
            ref var link = ref Links.Get(message.Entity);
