...
namespace Entia.Unity.Templaters
{
	public sealed class Unity<T> : Templater<Components.Unity<T>> where T : UnityEngine.Object
	{
		public override Result<IInitializer> Initializer(Components.Unity<T> value, Context context, World world) => new Identity();
